...
- [x] 4.1 Run the cleanup pipeline: `gx branch finish --branch agent/claude/gx-gaps-roadmap-2026q2-2026-05-11-16-08 --base main --via-pr --wait-for-merge --cleanup`. This handles commit -> push -> PR create -> merge wait -> worktree prune in one invocation.
