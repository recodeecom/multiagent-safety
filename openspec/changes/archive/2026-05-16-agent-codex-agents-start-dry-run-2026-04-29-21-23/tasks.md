...
- [x] 4.1 Run the cleanup pipeline: `gx branch finish --branch agent/codex/agents-start-dry-run-2026-04-29-21-23 --base main --via-pr --wait-for-merge --cleanup`. This handles commit -> push -> PR create -> merge wait -> worktree prune in one invocation.
