...
- [x] 4.1 Run the cleanup pipeline: `gx branch finish --branch agent/codex/codex-task-2026-05-11-09-45 --base main --via-pr --wait-for-merge --cleanup`. This handles commit -> push -> PR create -> merge wait -> worktree prune in one invocation.
